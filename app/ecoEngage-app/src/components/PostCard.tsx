...
import {Card, CardContent, TextField, IconButton, Snackbar, Alert, Collapse, Grid} from "@mui/material";
...
import {deletePost, getPosts, toggleLikeUnlike, updatePost} from "../services/posts-service.ts";
...
const PostCard: React.FC<PostProps> = ({post}) => {
    ...
    const handleAddComment = async () => {
        ...
        const createdComment = await dispatch(createCommentThunk([post.id, newComment]));
    ...
    const handlePostSaveClick = async () => {
        ...
        try {
            ...
            setIsErrorPost(true);
            setErrorMessagePost("Failed to update the post. You're not authorized to make any updates to this post.");
            setSnackbarOpenPost(true);
        }
    };
    ...
    const handlePostDeleteClick = async () => {
        ...
        try {
            ...
            setIsErrorPost(true);
            setErrorMessagePost("Failed to delete the post. You're not authorized to make any updates to this post.");
            setSnackbarOpenPost(true);
        }
    };
        ...
        <ThemeProvider theme={environmentalTheme}>
            ...
            >
                        ...
                        {post.image && (
                            <Grid item xs={12} style={{ textAlign: 'center' }}>
                                <img
                                    ...
                                    onError={(e) => { (e.target as HTMLImageElement).onerror = null; (e.target as HTMLImageElement).src = ''; }}
                                />
                            </Grid>
                        )}
                        <Grid item xs={12}>
                ...
                >
                    ...
                    >
                        {isErrorComment ? errorMessageComment : "Comment created successfully!"}
                    </Alert>
                </Snackbar>
            </Card>
        </ThemeProvider>
